...
import com.mxterminal.channel.RetryingTCPChannel;
 ...
 * @see ConnectionSSH2
 */
public final class ListenerSSH2 implements Runnable {
    private final static int LISTEN_QUEUE_SIZE = 32;
    static Logger logger = Logger.getLogger(ListenerSSH2.class);
     ...
     */
    public ListenerSSH2(String localAddr, int localPort,
    ...
    throws IOException {
        ...
        if(this.isLocalForward) {
            this.channelType = ConnectionSSH2.CH_TYPE_DIR_TCPIP;
        } else {
            this.channelType = ConnectionSSH2.CH_TYPE_FWD_TCPIP;
        }
     ...
     */
    public ListenerSSH2(String localAddr, int localPort,
                        ConnectionSSH2 connection) throws IOException {
    ...
    public void doConnect(Socket fwdSocket) {
        ...
        try {
            ...
            if(numOfRetries > 0) {
                RetryingTCPChannel retryChan =
                    new RetryingTCPChannel(channelType, connection, this,
                                               fwdSocket,
                ...
                channel =
                    new TCPChannel(channelType, connection, this,
                                       fwdSocket,
                                       remoteAddr, remotePort,
            ...
            connection.setSocketOptions(PreferencesSSH2.SOCK_OPT_LOCAL +
     ...
     */
    public void sendChannelOpen(TCPChannel channel, Socket fwdSocket) {
