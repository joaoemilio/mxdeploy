...
public class Authenticator {
     ...
     */
    public Authenticator(String username,String hostname) {
     ...
     */
    public synchronized AuthModule getModule(String method) {
        return (AuthModule)authModules.get(method);
    }
     ...
     */
    public void moduleFailure(String method, ExceptionSSH2 e) {}
     ...
     */
    public final synchronized void addModule(AuthModule module) {
    ...
    public void clearSensitiveData() {
        for (Enumeration e = authModules.elements() ; e.hasMoreElements() ;) {
            ((AuthModule)e.nextElement()).clearSensitiveData();
        }
    }
