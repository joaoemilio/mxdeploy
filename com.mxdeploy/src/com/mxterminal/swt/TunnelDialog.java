...
public class TunnelDialog {
	...
	private TunnelComposite tunnelComposite = null;
	/**
	...
	public void createSShell(String title) {
		...
		tunnelComposite = new TunnelComposite(sShell,SWT.NONE);
		tunnelComposite.setLayoutData(gridData);
	...
	public TunnelHelper getHelper(){
		return tunnelComposite.getHelper();
	}	
