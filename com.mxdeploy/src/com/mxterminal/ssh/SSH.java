...
public abstract class SSH {
    ...
    public final static String VER_IESTTERM  = "MXTerminal " + Version.version;
    public final static String VER_IESTTUNL  = "MXTunnel " + Version.version;
    public final static String CVS_NAME      = "$Name: v1.0.0 $";
    public final static String CVS_DATE      = "$Date: 2014/01/01 09:39:07 $";
    ...
    public boolean isProtocolFlagSet(int protFlag) {
    ...
    public static void logIgnore(PduInputStreamSSH pdu) {
        if(DEBUG)
    ...
    protected void initCipher(boolean server) throws IOException {
        sndCipher = CipherSSH.getInstance(cipherClasses[cipherType][0]);
        rcvCipher = CipherSSH.getInstance(cipherClasses[cipherType][0]);
