...
import com.mxsecurity.util.StringUtil;


public final class Radix64 {
    /**
     ...
     */
    public Radix64(String headerLine, String tailLine,
     ...
     */
    public Radix64(String headerLinePrePostFix) {
    ...
    com.mxterminal.util.HexDump.hexDump(decoded, 0, decoded.length);
    System.out.println("Headers:");
    System.out.println(armour.printHeaders());
