 ...
 *
 * @see OutputStreamTransport
 * @see java.io.PipedInputStream
 * @see java.io.PipedOutputStream
 */
public final class InputStreamTransport extends InputStream {

    private static final int DEFAULT_BUFFER_SIZE = 8192;

    private OutputStreamTransport source;
     ...
     */
    public InputStreamTransport(int bufferSize) {
     ...
     */
    public InputStreamTransport(OutputStreamTransport source) throws IOException {
        this();
        connect(source);
    }
     ...
     */
    public void connect(OutputStreamTransport source) throws IOException {
