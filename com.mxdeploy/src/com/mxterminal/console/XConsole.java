...
public final class XConsole extends ConsoleInterpreter {
    ...
    public XConsole(int personality) {
        try {
    ...
    public int interpretChar(char c) {
        ...
        case CASE_PRINT:
            ...
            case CHARSET_ASCII_ALT2:
                ...
                break;
            case CHARSET_LINES:
                if(!term.getOption(CompatConsole.OPT_ASCII_LDC)) {
                    if (c  < 0x5f) {
                        ic = (int)c;
                    } else {
    ...
    protected void ansiModes(boolean set
        ...
        for(int i = 0; i < nparam; i++) {
            ...
            case 4:
                ...
                term.setOption(CompatConsole.OPT_INSERTMODE, set);
                break;
            case 12:
                if(DEBUGNOTIMPL)
            ...
            case 20:
                ...
                term.setOption(CompatConsole.OPT_AUTO_LF, set);
                break;
            default:
                if(DEBUGNOTIMPL)
    ...
    protected void sgrModes() {
        for(int i = 0; i < nparam; i++) {
            ...
            case 5:
                ...
                term.setAttribute(CompatConsole.ATTR_BOLD, true);
                break;
            case 4:
                term.setAttribute(CompatConsole.ATTR_UNDERLINE, true);
                break;
            case 7:
                term.setAttribute(CompatConsole.ATTR_INVERSE, true);
                break;
            case 8:
                if(DEBUGNOTIMPL)
                ...
                break;
            case 22:
                term.setAttribute(CompatConsole.ATTR_BOLD, false);
                break;
            case 24:
                term.setAttribute(CompatConsole.ATTR_UNDERLINE, false);
                break;
            case 25:
                term.setAttribute(CompatConsole.ATTR_BOLD, false); // !!! Actually no-blink
                break;
            case 27:
                term.setAttribute(CompatConsole.ATTR_INVERSE, false);
                break;
            case 28:
                if(DEBUGNOTIMPL)
    ...
    protected void dpModes(boolean set) {
        for(int i = 0; i < nparam; i++) {
            ...
            case 3:
                ...
                term.setOption(CompatConsole.OPT_DECCOLM, set);
                break;
            case 4:
                if(DEBUGNOTIMPL)
            ...
            case 5:
                ...
                term.setOption(CompatConsole.OPT_REV_VIDEO, set);
                break;
            case 6:
                if(DEBUG)
            ...
            case 7:
                ...
                term.setOption(CompatConsole.OPT_AUTO_WRAP, set);
                break;
            case 8:
            ...
            case 25:
                ...
                term.setOption(CompatConsole.OPT_VIS_CURSOR, set);
                break;
            case 38:
                if(DEBUGNOTIMPL)
            ...
            case 40:
                ...
                term.setOption(CompatConsole.OPT_DEC132COLS, set);
                break;
            case 41:
                if(DEBUGNOTIMPL)
            ...
            case 45:
                ...
                term.setOption(CompatConsole.OPT_REV_WRAP, set);
                break;
            case 46:
                if(DEBUGNOTIMPL)
    ...
    public void keyHandler(char c, int virtualKey, int modifiers) {
        ...
        case KeyEvent.VK_HOME:
            if(!term.getOption(CompatConsole.OPT_LOCAL_PGKEYS)) {
                prefix = replyTypes[R_CSI];
                specialKey = mapSpecialKeys(virtualKey, modifiers);
            }
            break;
        ...
        if ((c == 0x0a || c == 0x0d)
            && term.getOption(CompatConsole.OPT_AUTO_LF)) {
