package com.mxsecurity.keystore;
...
import com.mxsecurity.jca.KeyStoreException;
import com.mxsecurity.jca.KeyStoreSpi;
...
import com.mxsecurity.jca.UnrecoverableKeyException;
import com.mxsecurity.jca.cert.Certificate;
...
import com.mxsecurity.pkcs12.AuthenticatedSafe;
import com.mxsecurity.pkcs12.CertBag;
import com.mxsecurity.pkcs12.PFX;
import com.mxsecurity.pkcs12.PKCS12PbeParams;
import com.mxsecurity.pkcs12.SafeBag;
import com.mxsecurity.pkcs12.SafeContents;
import com.mxsecurity.pkcs7.ContentInfo;
import com.mxsecurity.pkcs7.EncryptedData;
import com.mxsecurity.pkcs8.EncryptedPrivateKeyInfo;
import com.mxsecurity.pkcs8.PrivateKeyInfo;
import com.mxsecurity.util.HexDump;
import com.mxsecurity.x509.Attribute;
import com.mxsecurity.x509.X509Certificate;
...
public class PKCS12KeyStore extends KeyStoreSpi {
    ...
    public PKCS12KeyStore() {
        ASN1OIDRegistry.addModule("com.mxsecurity.pkcs12");
    ...
    throws UnrecoverableKeyException {
        ...
        try {
            ...
            if (isrsakey) {
                com.mxsecurity.pkcs1.RSAPrivateKey rsa =
                    new com.mxsecurity.pkcs1.RSAPrivateKey();
                ber.decode(ba, rsa);
            ...
            com.mxsecurity.pkcs1.DSAParams params =
                (com.mxsecurity.pkcs1.DSAParams)pki.privateKeyAlgorithm.parameters.getValue();
