...
public class RegisteredTypes extends ASN1OIDRegistry {
    ...
    public RegisteredTypes() {
         ...
         */
        put("2.5.29.14", "com.mxsecurity.x509.SubjectKeyIdentifier");
        put("2.5.29.15", "com.mxsecurity.x509.KeyUsage");
        put("2.5.29.16", "com.mxsecurity.x509.PrivateKeyUsagePeriod");
        put("2.5.29.17", "com.mxsecurity.x509.SubjectAltName");
        put("2.5.29.18", "com.mxsecurity.x509.IssuerAltName");
        put("2.5.29.19", "com.mxsecurity.x509.BasicConstraints");
        put("2.5.29.30", "com.mxsecurity.x509.NameConstraints");
        put("2.5.29.32", "com.mxsecurity.x509.CertificatePolicies");
        put("2.5.29.33", "com.mxsecurity.x509.PolicyMappings");
        put("2.5.29.35", "com.mxsecurity.x509.AuthorityKeyIdentifier");
        put("2.5.29.36", "com.mxsecurity.x509.PolicyConstraints");
        ...
        // commonName
        put("2.5.4.3", "com.mxsecurity.x509.DirectoryString");
        // surname
        put("2.5.4.4", "com.mxsecurity.x509.DirectoryString");
        // serialNumber
        put("2.5.4.5", "ASN1PrintableString");
        // countryName
        put("2.5.4.6", "ASN1PrintableString");
        // localityName
        put("2.5.4.7", "com.mxsecurity.x509.DirectoryString");
        // stateOrProvinceName
        put("2.5.4.8", "com.mxsecurity.x509.DirectoryString");
        // streetAddress
        put("2.5.4.9", "com.mxsecurity.x509.DirectoryString");
        // organizationName
        put("2.5.4.10", "com.mxsecurity.x509.DirectoryString");
        // organizationalUnitName
        put("2.5.4.11", "com.mxsecurity.x509.DirectoryString");
        // title
        put("2.5.4.12", "com.mxsecurity.x509.DirectoryString");
        // description
        put("2.5.4.13", "com.mxsecurity.x509.DirectoryString");
        // businessCategory
        put("2.5.4.15", "com.mxsecurity.x509.DirectoryString");
        // postalAddress
        put("2.5.4.16", "com.mxsecurity.x509.PostalAddress");
        // postalCode
        put("2.5.4.17", "com.mxsecurity.x509.DirectoryString");
        // postOfficeBox
        put("2.5.4.18", "com.mxsecurity.x509.DirectoryString");
        // telephoneNumber
        put("2.5.4.20", "ASN1PrintableString");
        // name
        put("2.5.4.41", "com.mxsecurity.x509.DirectoryString");
        // givenName
        put("2.5.4.42", "com.mxsecurity.x509.DirectoryString");
        // initials
        put("2.5.4.43", "com.mxsecurity.x509.DirectoryString");
        // generationQualifier
        put("2.5.4.44", "com.mxsecurity.x509.DirectoryString");
        // uniqueIdentifier
        put("2.5.4.45", "ASN1BitString");
        // dnQualifier
        put("2.5.4.46", "ASN1PrintableString");
        // pseudonym
        put("2.5.4.65", "com.mxsecurity.x509.DirectoryString");
        ...
        // placeOfBirth
        put("1.3.6.1.5.5.7.9.2", "com.mxsecurity.x509.DirectoryString");
        // gender
        ...
        put("1.2.840.10040.4.1","com.mxsecurity.pkcs1.DSAParams");
