...
public class ServerEditDialog { 
    ...
    protected ServerComposite composite = null;
	...
	public void createSShell(String title) {
		...
		sShell.setSize(new Point(440, 500));
		
		composite = new ServerComposite(sShell,SWT.NONE);		
	...
	public ServerEditHelper getHelper(){
