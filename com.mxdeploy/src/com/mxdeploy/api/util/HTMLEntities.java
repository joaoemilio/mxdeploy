...
public class HTMLEntities
{
    ...
    public static String htmlentities(String str)
    {
        ...
        for(int i = 0; i < str.length(); i++)
        {
            ...
            {
                if(ch > '\200')
                    buf.append((new StringBuilder()).append("&#").append(ch).append(";").toString());
                else
                    buf.append(ch);
            } else
            {
    ...
    public static String encoder(String str)
    {
        if(str == null)
            ...
            return htmlQuotes(htmlentities(str));
    }
    ...
    {
        return unhtmlQuotes(unhtmlentities(str));
    }
    ...
    public static void main2(String args[])
    {
        ...
        try
        {
            ...
            System.out.println(URLEncoder.encode("human \250 Java", "UTF-8"));
        }
    ...
    {
        String rawstr = new String("<b>\303\240\303\250\303\254\303\262\303\271\342\u201A\254\342\u201A\254\342\u201A\254<b>");
        String htmlstr = new String("<b>&agrave;&egrave;&igrave;&ograve;&ugrave;&euro;&#8364;&#x20AC;<b>");
        System.out.println((new StringBuilder()).append("original string 1: ").append(rawstr).toString());
        System.out.println((new StringBuilder()).append("encoder string 1: ").append(encoder(rawstr)).toString());
        System.out.println((new StringBuilder()).append("original string 2: ").append(htmlstr).toString());
        System.out.println((new StringBuilder()).append("decoder string 2: ").append(decoder(htmlstr)).toString());
        System.out.println((new StringBuilder()).append("encoder mixed: & &amp; \342\u201A\254 = ").append(encoder("& &amp; \342\u201A\254")).toString());
        System.out.println((new StringBuilder()).append("decoder mixed: & &amp; &amp; = ").append(decoder("& &amp; &amp;")).toString());
        System.out.println((new StringBuilder()).append("htmlSingleQuotes: ' = ").append(htmlSingleQuotes("'")).toString());
        System.out.println((new StringBuilder()).append("unhtmlSingleQuotes: &rsquo; = ").append(unhtmlSingleQuotes("&rsquo;")).toString());
        System.out.println((new StringBuilder()).append("htmlDoubleQuotes: \" = ").append(htmlDoubleQuotes("\"")).toString());
        System.out.println((new StringBuilder()).append("unhtmlDoubleQuotes: &quot; = ").append(unhtmlDoubleQuotes("&quot;")).toString());
        System.out.println((new StringBuilder()).append("htmlQuotes: '\" = ").append(htmlQuotes("'\"")).toString());
        System.out.println((new StringBuilder()).append("unhtmlQuotes: &rsquo;&quot; = ").append(unhtmlQuotes("&rsquo;&quot;")).toString());
        System.out.println((new StringBuilder()).append("htmlAngleBrackets: <> = ").append(htmlAngleBrackets("<>")).toString());
        System.out.println((new StringBuilder()).append("unhtmlAngleBrackets: &lt;&gt; = ").append(unhtmlAngleBrackets("&lt;&gt;")).toString());
        System.out.println((new StringBuilder()).append("htmlAmpersand: & = ").append(htmlAmpersand("&")).toString());
        System.out.println((new StringBuilder()).append("unhtmlAmpersand: &amp; = ").append(unhtmlAmpersand("&amp;")).toString());
    }
