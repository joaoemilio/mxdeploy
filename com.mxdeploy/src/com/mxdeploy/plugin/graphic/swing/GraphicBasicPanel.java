...
import com.mxdeploy.plugin.graphic.swing.event.GraphicKeyboardHandler;
...
public class GraphicBasicPanel extends JPanel {
	...
	public GraphicBasicPanel(String appTitle, mxGraphComponent component) {
	 ...
	 */
	 protected void installHandlers()  {
		 ...
		 keyboardHandler = new GraphicKeyboardHandler(graphComponent);
	 }
	 ...
	 * 
	 */
	 public GraphicPalette insertPalette(String title) {
		 final GraphicPalette palette = new GraphicPalette();
	...
	protected void showGraphPopupMenu(MouseEvent e) {
		...
		GraphicPopupMenu menu = new GraphicPopupMenu(GraphicBasicPanel.this);
		...
		MouseWheelListener wheelTracker = new MouseWheelListener() {
			...
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (e.getSource() instanceof mxGraphOutline
						|| e.isControlDown()) {
					GraphicBasicPanel.this.mouseWheelMoved(e);
				}
			}
	...
	public Action bind(String name, final Action action, String iconUrl) {
		...
		if ((iconUrl != null)) {
			imageIcon = new ImageIcon(GraphicBasicPanel.class.getResource(iconUrl));
		}
