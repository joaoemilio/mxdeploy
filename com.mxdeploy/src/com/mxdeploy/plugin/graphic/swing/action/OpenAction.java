...
import com.mxdeploy.plugin.graphic.swing.DefaultFileFilter;
...
public class OpenAction extends AbstractAction {
	 ...
	 * 
	 */
	protected void resetEditor(GraphicBasicPanel editor) {
	 ...
	 */
	public void openXmlPng(GraphicBasicPanel editor, File file)
			throws IOException {
	 ...
	 * 
	 */
	protected void openGD(GraphicBasicPanel editor, File file, String gdText) {
			...
			if (!editor.isModified() || JOptionPane.showConfirmDialog(editor, mxResources.get("loseChanges")) == JOptionPane.YES_OPTION) {
				...
				if (graph != null) {
					...
					DefaultFileFilter defaultFilter = 
						new DefaultFileFilter(".mxe", mxResources.get("allSupportedFormats") + " (.mxe, .png, .vdx)") {
